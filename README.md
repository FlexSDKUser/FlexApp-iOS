...
![Build Phases](https://create-s3-test1.s3.ap-northeast-2.amazonaws.com/readme-ios-sdk/buildphasetab.png "Build Phases")
</br>
It creates **Copy Files section**. From **Copy Bundle Resources** move **Assets.xcassets** to **Copy Files section** by drag and drop.
![Copy Files](https://create-s3-test1.s3.ap-northeast-2.amazonaws.com/readme-ios-sdk/moveassets.png "Copy Files")
</br>
...
### Step 8: Enable **Remote notifications**
...
### Step 9: Add these permission required for framework in your project `Info.plist`
...
### Step 11: To receive Push Notifications
...
### Step 12: Add `GoogleServices-Info.plist` file in your project
